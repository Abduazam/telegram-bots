...
class DefaultBotTextsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $texts = [
            ...
            'add-tasks-amount-text' => "Вирд бўйича кунлик бажариш қийматини киритинг",
            'add-tasks-schedule-text' => "Вирд бўйича куннинг қайси куни эслатма қўймоқчисиз?\n(Мисол учун: 11:00 ёки 20:00)",
            'add-tasks-files-text' => "Вирд бўйича файлларингиз бўлса юкланг",
        ];
